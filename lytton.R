...
# now plot
plot( 1:365, ulim_all , type='l', xlab = "Day of year", ylab = "Tmax", ylim=c(0,50), main='Tmax extremes (99.99 percentile)\n5 day window (day of year ± 2 days)')
ss <- subset(d, year == 2021)
lines( 1:365, ulim_current, col='green' )
lines( tmax ~ jday, ss, col='red')
legend( x = 0, y= 49, legend = c("1921 - 2020 (all stations)",'2006 - 2020 (current station)', '2021'), col=c('black','green','red'), lty = c(1,1))